...
export const data: DataType[] = [
  ...
  },
  {
    ...
    impressions:
      "どうせ画像処理100本ノックをやるなら、誰でも気軽に実行できれば便利だと思って開発。〇〇100本ノックで共通して使えそう。",
  },
  {
    name: "VRooM",
    date: "November 2022",
    ...
    links: [
      ...
      {
        name: "JPHACKS 2022",
        url: "https://jphacks.com/information/result-report2022/",
      },
    ],
    images: ["/imgs/projects/VRooM_1.jpeg"],
    impressions:
      "JPHACKS2022で大学の先輩と開発したアプリ。あなたを励ます、好きなアバターをアップロードしてみてください。",
  },
  {
    ...
    impressions:
      "ラズパイの学生実験中に開発したゲーム。なんとPythonの標準ライブラリのみでコマンドラインで遊べます。",
  },
  {
    ...
    impressions:
      "ブラウザ上でも滑らかなスピードキューブ体験を。開発途中なので、乞うご期待。",
  },
  {
    name: "Netflix Clone",
    date: "October 2022",
    ...
    links: [
      ...
      {
        name: "Webサイト",
        url: "https://react-netflix-clone-kitsuya0828.vercel.app/",
      },
    ],
    images: [
    ...
    impressions:
      "初めてのReact制作物。友達に今期見てるアニメを紹介するときに重宝しています。",
  },
  {
    name: "PoiNe!",
    date: "September 2022",
    ...
    links: [
      ...
      {
        name: "Webアプリ",
        url: "kitsuya0828-inpersonation-app-home-aaa1x7.streamlitapp.com/",
      },
      { name: "Digital Hack Day 2022", url: "https://hackday.yahoo.co.jp/" },
    ],
    images: ["/imgs/projects/PoiNe_2.jpeg", "/imgs/projects/PoiNe_1.png"],
    impressions:
      "お題を選んで録音すると、声の特徴量からモノマネを評価してくれます。ハッカソンで開発してボロ負けしました。",
  },
  {
    name: "Lecapy",
    date: "April 2022",
    ...
    links: [
      ...
      {
        name: "Qiita",
        url: "https://qiita.com/adumaru0828/items/3043d6a668cc7d4ae0e0",
      },
      { name: "YouTube", url: "https://www.youtube.com/watch?v=-df1Wrm1CQ4" },
      {
        name: "Webアプリ",
        url: "https://kitsuya0828-lecapy-app-ev7sde.streamlit.app/",
      },
    ],
    images: ["/imgs/projects/Lecapy_1.avif", "/imgs/projects/Lecapy_2.avif"],
    impressions:
      "講義スライドをアップロードしてくれない授業のために開発。ビデオから、一瞬で良さげなスライドに。",
  },
  {
    name: "Blicky",
    date: "November 2021",
    ...
    links: [
      ...
      {
        name: "JPHACKS 2022",
        url: "https://jphacks.com/information/result-report2021/",
      },
    ],
    images: [
    ...
    impressions:
      "JPHACKS2021で一人寂しく開発したアプリ。アイデアが評価されて、スポンサー賞をたくさん頂いた。",
  },
  {
    name: "SkiMee",
    date: "October 2021",
    ...
    images: ["/imgs/projects/SkiMee_1.png", "/imgs/projects/SkiMee_2.png"],
    impressions:
      "コロナ禍で急速に普及したオンライン会議。退屈な会議中に居眠りしても勝手に退出してくれるようなサービスを作りました。",
  },
];
