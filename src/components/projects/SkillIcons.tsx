...
import { SiNextdotjs, SiPython, SiReact, SiTypescript, SiStreamlit, SiFastapi, SiDocker, SiGo, SiTerraform, SiGooglecloud, SiPrometheus, SiGrafana } from 'react-icons/si';
